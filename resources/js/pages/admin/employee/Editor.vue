        ...
        <q-form class="row" @submit.prevent="submit" @validation-error="scrollToFirstErrorField">
          <q-card square flat bordered class="col">
            ...
            <q-card-section class="q-pt-none">
              ...
              <q-input autofocus v-model.trim="form.nik" label="NIK" lazy-rules :error="!!form.errors.nik"
                :disable="form.processing" :error-message="form.errors.nik" :rules="[
                  (val) => (val && val.length > 0) || 'NIK harus diisi.',
                ]" />
              ...
              <q-input v-model.trim="form.name" label="Nama" lazy-rules :error="!!form.errors.name"
